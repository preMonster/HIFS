  ...
  <div class="title">
    ...
    <div class="flex-right">
      ...
      <div @click="changeUserInfoState"
        ...
        <Icon :type="userInfoState?'arrow-up-b':'arrow-down-b'"
              class="icon"></Icon>
      </div>
    </div>
    <transition name="slide-fade">
      <div v-if="userInfoState"
           class="userInfoContentDiv">
        <form @submit.prevent>
          <div class="userInfoContentImgDiv">
            <input ref="imgFile"
                   class="headimg-fileinput"
                   type="file" />
          ...
          <SpecialForm :state="editState"
                       :data="userInfo"
                       :changeData="changeUserInfo"></SpecialForm>
          ...
          <div class="btns">
            ...
            <i-button @click="outLogin"
                      type="error">退出登录</i-button>
          </div>
        </form>
      </div>
    </transition>
